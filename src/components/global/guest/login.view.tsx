...
export const LoginView: FC<{  }> = props => {
    ...
    return (<div className="bg-gray dark:bg-gray bg-opacity-75 w-screen h-screen">
        <div className="absolute bg-white dark:bg-black bg-opacity-75 dark:bg-opacity-75 rounded-r-10px w-415px h-screen">
            <div className="absolute top-12 left-12 font-inter not-italic font-semibold text-black dark:text-white text-16px">Welcome</div>
